...
import com.aidor.secchargemobile.seccharge.MyReservationsActivity;
...
public class CustomListForViewReserve extends BaseAdapter{
    Context context;
    List<Reservationdetail> reservationList;
    private static LayoutInflater inflater = null;

    public CustomListForViewReserve(MyReservationsActivity viewReserveActivity,

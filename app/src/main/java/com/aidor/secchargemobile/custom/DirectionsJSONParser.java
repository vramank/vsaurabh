        ...
        try {
            ...
            for(int i=0;i<jRoutes.length();i++){
                ...
                for(int j=0;j<jLegs.length();j++){
                    String distance1=((JSONObject) ((JSONObject)jLegs.get(0)).get("distance")).get("value").toString();
                    Dec.distance = distance1;
                    ...
                    for(int k=0;k<jSteps.length();k++){
                        ...
                        LatLng midPoint = getPolygonCenterPoint(list);
                        Dec.centerOfPolyLine = midPoint;
